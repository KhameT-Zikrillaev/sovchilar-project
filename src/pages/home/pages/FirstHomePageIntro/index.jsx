        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2">
            <div className="backdrop-blur-md rounded-[40px] p-14 bg-gradient-to-br from-black/80 to-black/60">
              ...
              <div className="mb-12">
                <div className="inline-block px-6 py-2 rounded-full bg-rose-500/30 text-rose-200 text-sm font-medium mb-6">
                  {t('home.FirstIntroPage.title')}
                </div>
                <h1 className="text-5xl lg:text-6xl font-bold leading-[1.2] mb-6">
              ...
              {/* Поиск */}
              <div className="bg-white/10 backdrop-blur-lg p-2 rounded-full mb-10 flex items-center">
                <button 
              ...
              <div className="flex items-center gap-4 mb-12">
                ...
                <button className="w-14 h-14 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/30 text-white transition duration-200">
              ...
              <div className="grid grid-cols-3 gap-4">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center px-4 py-6 rounded-2xl bg-white/10 hover:bg-white/20 transition duration-200">
        ...
        <div className="mt-24">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {features.map((feature, index) => (
              <div key={index} className="bg-gradient-to-br from-black/80 to-black/60 backdrop-blur-md p-8 rounded-3xl hover:transform hover:scale-105 transition duration-300">
          ...
          {/* Призыв к действию */}
          <div className="max-w-3xl mx-auto text-center bg-gradient-to-r from-rose-500/20 to-black/60 backdrop-blur-md p-12 rounded-[2.5rem]">
