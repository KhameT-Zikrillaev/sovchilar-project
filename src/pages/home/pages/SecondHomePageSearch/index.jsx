...
export default function SecondHomePageSearch() {
  ...
  return (
    <section className="py-16 px-4 bg-gray-50 overflow-hidden" id="search">
      {isLoading && (
        <Loading type="default" size="large" color="rose" overlay />
      )}
      <div className="container mx-auto py-[64px]">
        <div className="flex flex-col items-center mb-12">
          ...
          >
            {t("home.SecondHomePageSearch.title")}
          </h1>
          <p
            data-aos="fade-up"
            data-aos-offset="50"
        ...
        <div
          className="flex flex-col sm:flex-row justify-center gap-4 mb-8 pt-[64px]"
          id="ankets"
        >
          {!isSearchActive && (
            <>
        ...
        {allUsers.length > visibleCardCount && (
          <div className="mt-12 text-center">
            ...
            >
              ...
              {Math.min(12, allUsers.length - visibleCardCount)}{" "}
              {t("home.SecondHomePageSearch.Anketa")}
            </button>
          </div>
        )}
      </div>
