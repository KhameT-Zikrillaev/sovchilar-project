        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              {...register("age", {
                ...
                max: {
                  value: 100,
                  message: "Yosh 100 dan kichik bo'lishi kerak",
                },
              })}
              className={inputClasses}
            ...
            />
            {errors.age && (
              <p className="mt-1 text-sm text-rose-500">{errors.age.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            <select
              id="city"
              {...register("address", {
                required: "Shaharni tanlash majburiy",
              })}
              className={selectClasses}
            >
          ...
          <div>
            ...
            <select
              ...
              {...register("qualification", {
                required: "Ta'limni tanlash majburiy",
              })}
              className={selectClasses}
            >
          ...
          <div>
            ...
            <select
              ...
              {...register("maritalStatus", {
                required: "Oilaviy holatni tanlash majburiy",
              })}
              className={selectClasses}
            >
              <option value="">
          ...
          <div>
            ...
            <input
              ...
              id="jobTitle"
              {...register("jobTitle", {
                required: "Kasbni kiritish majburiy",
              })}
              className={inputClasses}
              placeholder="Kasbingizni kiriting"
            />
            {errors.job && (
              <p className="mt-1 text-sm text-rose-500">{errors.job.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            <select
              ...
              {...register("nationality", {
                required: "Millatni tanlash majburiy",
              })}
              className={selectClasses}
            >
              <option value="">
        ...
        <div>
          ...
          <textarea
            ...
            {...register("description", {
              ...
              minLength: {
                value: 50,
                message: "Talablar kamida 50 ta belgidan iborat bo'lishi kerak",
              },
            })}
            rows="4"
            className={inputClasses}
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-2xl max-w-2xl w-full m-4 space-y-4">
            ...
            <div className="prose">
              ...
              <p>
                2. Noto'g'ri ma'lumot berganlik uchun javobgarlik
                foydalanuvchining zimmasida.
              </p>
