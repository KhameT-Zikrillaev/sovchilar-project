      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <a href="" className="px-4 py-2 text-gray-600 hover:text-rose-500 hover:bg-rose-50 rounded-full transition-all">
              {t('navbar.contact')}
            </a>
            <Link 
              to="/auth" 
        ...
        {isOpen && (
          <div className="md:hidden py-4">
            <div className="flex flex-col space-y-2">
              ...
              <a href="" onClick={() => setIsOpen(false)}  className="px-4 text-left py-2 text-gray-600 hover:text-rose-500 hover:bg-rose-50 rounded-lg">
